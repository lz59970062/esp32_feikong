...
void setup()
{
  ...
  gethigh_init();
  ({ do { if (__builtin_constant_p(!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC)) && !(!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC))) { extern __attribute__((error("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"))) void failed_compile_time_assert(void); failed_compile_time_assert(); } (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("e:\\飞总\\电赛\\main.ino", 50, __PRETTY_FUNCTION__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC))")); } while(0);; (*((volatile uint32_t *)((0x3ff48000 + 0xd4)))) = (uint32_t)(0); }); //关闭低电压检测,避免无限重启
  xTaskCreatePinnedToCore(Task1, "Task1", 10000, 
# 51 "e:\\飞总\\电赛\\main.ino" 3 4
                                                __null
# 51 "e:\\飞总\\电赛\\main.ino"
                                                    , 2, 
# 51 "e:\\飞总\\电赛\\main.ino" 3 4
...
# 52 "e:\\飞总\\电赛\\main.ino"
                                                             , 1);
  xTaskCreatePinnedToCore(vTask3, "rate", 20000, 
# 53 "e:\\飞总\\电赛\\main.ino" 3 4
                                                __null
# 53 "e:\\飞总\\电赛\\main.ino"
                                                    , 1, 
# 53 "e:\\飞总\\电赛\\main.ino" 3 4
...
# 54 "e:\\飞总\\电赛\\main.ino"
                                                            , 1);
  xTaskCreatePinnedToCore(task_high, "high_pid", 30000, 
...
# 56 "e:\\飞总\\电赛\\main.ino"
                                                                   , 0);
  xTaskCreatePinnedToCore(task_hpos, "hpos", 4000, 
...
# 57 "e:\\飞总\\电赛\\main.ino"
                                                               , 0);
  xTaskCreatePinnedToCore(task_high_acc, "high_acc", 8000, 
...
# 200 "e:\\飞总\\电赛\\main.ino" 3 4
                                    __null
# 200 "e:\\飞总\\电赛\\main.ino"
                                        );
      vTaskPrioritySet(
# 201 "e:\\飞总\\电赛\\main.ino" 3 4
                      __null
# 201 "e:\\飞总\\电赛\\main.ino"
                          , (uxPriority - 2));
      flag = 1;
    }
